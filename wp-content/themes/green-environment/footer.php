            ...
            <div class="container">
              <div class="row sidebar-area footer-area">
                <div id="categories-2" class="col-lg-3 col-md-6 widget_categories wow rollIn">
                    <h4 class="title"><?php esc_html_e('Categories', 'green-environment'); ?></h4>
                    <ul>
                        <?php
                ...
                <div id="pages-2" class="col-lg-3 col-md-6 widget_pages wow rollIn">
                    <h4 class="title"><?php esc_html_e('Pages', 'green-environment'); ?></h4>
                    <ul>
                        <?php
                        wp_list_pages(array(
                            'title_li' => '',
                ...
                <div id="archives-2" class="col-lg-3 col-md-6 widget_archive wow rollIn">
                    <h4 class="title"><?php esc_html_e('Archives', 'green-environment'); ?></h4>
                    <ul>
                        <?php
                ...
                <div id="calendar" class="col-lg-3 col-md-6 widget_calendar wow rollIn">
                  <h4 class="title"><?php esc_html_e('Calendar', 'green-environment'); ?></h4>
                  <?php get_calendar(); ?>
                </div>
              </div>
            </div>
          ...
          <div class="copy-text">
            <p class="mb-0 py-3">
              <?php
                ...
                <a href="<?php echo esc_url('https://www.misbahwp.com/products/free-green-wordpress-theme'); ?>" target="_blank">
