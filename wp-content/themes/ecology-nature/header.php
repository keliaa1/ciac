...
?>
<?php $ecology_nature_icon1 = get_theme_mod( 'ecology_nature_dashicons_setting_1', 'dashicons dashicons-controls-volumeon' ); ?>
<?php $ecology_nature_icon2  = get_theme_mod( 'ecology_nature_dashicons_setting_2', 'dashicons dashicons-airplane' );
 ?>


<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'ecology-nature' ); ?></a>

<?php if(get_theme_mod('ecology_nature_site_loader',false)!= ''){ ?>
    <?php if(get_theme_mod( 'ecology_nature_preloader_type','four-way-loader') == 'four-way-loader'){ ?>
	    <div class="cssloader">
	    	<div class="sh1"></div>
	    	<div class="sh2"></div>
	    	<h1 class="lt"><?php esc_html_e( 'loading',  'ecology-nature' ); ?></h1>
	    </div>
    <?php }else if(get_theme_mod( 'ecology_nature_preloader_type') == 'cube-loader') {?>
		<div class="cssloader">
...
<div class="top-header text-center text-md-start py-3 wow fadeInLeft">
		<div class="container"> 
		<div class="row">
				...
				<div class="row">
						...
						<?php if ( get_theme_mod('ecology_nature_header_phone_number') || get_theme_mod('ecology_nature_header_phone_number_text') ) : ?>
							<div class="row contact-box">
								<div class="col-lg-3 col-md-3 align-self-center">
									<span class="dashicons dashicons-<?php echo esc_attr( $ecology_nature_icon1 ); ?>"></span>
								</div>
					...
					<div class="col-lg-6 col-md-6 align-self-center">
						<?php if ( get_theme_mod('ecology_nature_header_email_address') || get_theme_mod('ecology_nature_header_email_address_text') ) : ?>
							<div class="row contact-box">
								<div class="col-lg-3 col-md-3 align-self-center">
									<span class="dashicons dashicons-<?php echo esc_attr( $ecology_nature_icon2  ); ?>"></span>
								</div>
								<div class="col-lg-9 col-md-9 align-self-center">
...
<div class="<?php if( get_theme_mod( 'ecology_nature_sticky_header', false) != '') { ?>sticky-header<?php } else { ?>close-sticky main-menus<?php } ?>">
	<header id="site-navigation" class="header text-center text-md-start wow fadeInRight">
		<div class="container">
			<div class="row">
						...
						<?php if ( is_array($ecology_nature_settings) || is_object($ecology_nature_settings) ){ ?>
						    	<?php foreach( $ecology_nature_settings as $ecology_nature_setting ) { ?>
							        <a href="<?php echo esc_url( $ecology_nature_setting['link_url'] ); ?>">
							            <i class="<?php echo esc_attr( $ecology_nature_setting['link_text'] ); ?> me-3"></i>
							        </a>
						    	<?php } ?>
						<?php } ?>
					</div>
