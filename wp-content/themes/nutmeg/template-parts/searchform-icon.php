...
<div id="site-masthead-search" class="ht-site-cell ht-site-cell--alignself-center ht-site-cell--nogrow">
	<button aria-label="<?php echo esc_attr('Expand container with Search Form','nutmeg'); ?>" id="site-search-toggle" class="site-toggle-searchform"><i class="icon-icomoon ilovewp-icon-search"></i></button>
