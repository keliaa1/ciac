<?php
class EDM_Builder_Module extends ET_Builder_Module {
	...
	protected function custom_background_fields(
		...
		$help_text       = esc_html__( 'Adjust the background style of this element by customizing the background color', 'edm-exclusive-divi-modules' );
		...
		if ( in_array( 'gradient', $background_tab, true ) ) {
			$help_text = $help_text . ', ' . esc_html__( 'gradient', 'edm-exclusive-divi-modules' );
		...
		if ( in_array( 'image', $background_tab, true ) ) {
			$help_text = $help_text . ', ' . esc_html__( 'image', 'edm-exclusive-divi-modules' );
		...
		$advanced_fields[ "{$option_name}_bg_color" ] = array(
			'label'             => sprintf( '%1$s %2$s', $option_label, esc_html__( 'Background', 'edm-exclusive-divi-modules' ) ),
	...
	protected function get_absolute_element_options( $prefix, $label, $slug, $defaults, $show_if ) {
		...
		$fields = array(
			"{$prefix}_position"    => array(
				'label'       => $label . esc_html__( ' Position', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Select ', 'edm-exclusive-divi-modules' ) . $label . esc_html__( ' placement.', 'edm-exclusive-divi-modules' ),
				'type'        => 'select',
				'tab_slug'    => 'advanced',
				'toggle_slug' => $slug,
			...
			"{$prefix}_is_center_x" => array(
				'label'           => esc_html__( 'Use Horizontal Position Center', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'If enabled ', 'edm-exclusive-divi-modules' ) . $label . esc_html__( ' will be in horizontally center position.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
			...
			"{$prefix}_offset_x"    => array(
				'label'          => esc_html__( 'Horizontal Offset', 'edm-exclusive-divi-modules' ),
				'description'    => $label . esc_html__( ' Horizontal offset value.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'mobile_options' => true,
			...
			"{$prefix}_is_center_y" => array(
				'label'           => esc_html__( 'Use Vertical Position Center', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'If enabled ', 'edm-exclusive-divi-modules' ) . $label . esc_html__( ' will be in vertically center position.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'off',
				'options'         => array(
			...
			"{$prefix}_offset_y"    => array(
				'label'          => esc_html__( 'Vertical Offset', 'edm-exclusive-divi-modules' ),
				'description'    => $label . esc_html__( ' vertical offset value.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'mobile_options' => true,
	...
	protected function get_badge_options( $prefix, $label, $slug, $defaults ) {
		$fields = array(
			"{$prefix}_padding" => array(
				'label'          => $label . esc_html__( ' Padding', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Padding adds extra space to the inside of the element, increasing the distance between the edge of the element and its inner contents.', 'edm-exclusive-divi-modules' ),
				'type'           => 'custom_padding',
				'tab_slug'       => 'advanced',
				'mobile_options' => true,
				'toggle_slug'    => $slug,
	...
	protected function get_overlay_option_fields( $opt_slug, $hover_status, $show_if ) {
		...
		$fields  = array(
			'overlay_on_hover'     => array(
				'label'           => esc_html__( 'Show Overlay on Hover', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Enable overlay during hover.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'Yes', 'edm-exclusive-divi-modules' ),
			...
			'overlay_hover_speed'  => array(
				'label'          => esc_html__( 'Overlay Hover Speed', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Set how long it will take for the overlay to be visible', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'fixed_unit'     => 'ms',
				'default'        => '300ms',
				'range_settings' => array(
			...
			'overlay_icon'         => array(
				'label'           => esc_html__( 'Overlay Icon', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Select icon for the overlay', 'edm-exclusive-divi-modules' ),
				'type'            => 'select_icon',
			...
			'overlay_icon_color'   => array(
				'label'       => esc_html__( 'Overlay Icon Color', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Here you can define a custom color for your overlay icon.', 'edm-exclusive-divi-modules' ),
				'type'        => 'color-alpha',
				'tab_slug'    => 'advanced',
				'default'     => '#2EA3F2',
				'toggle_slug' => $opt_slug,
			...
			'overlay_icon_size'    => array(
				'label'          => esc_html__( 'Overlay Icon Size', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Here you can define a icon size for your overlay icon.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '32px',
				'hover'          => 'tabs',
				'range_settings' => array(
			...
			'overlay_icon_opacity' => array(
				'label'          => esc_html__( 'Overlay Icon Opacity', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Select the opacity of the overlay icon. Set the value from 0 - 1. The lower value, the more transparent.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '1',
				'unitless'       => true,
				'range_settings' => array(
		...
		$overlay = $this->custom_background_fields(
			'overlay',
			esc_html__( 'Overlay', 'edm-exclusive-divi-modules' ),
			'advanced',
			$opt_slug,
	...
	protected function get_overlay_style(
		...
		if ( ! empty( $photo_opt_name ) ) {
			...
			if ( ! empty( $raddi ) ) {
				...
				ET_Builder_Element::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%% .edm-overlay',
						'declaration' => sprintf(
							'
		...
		if ( 'on' === $overlay_on_hover ) {
			...
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => $hover_element . ':hover .edm-overlay',
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .edm-overlay .edm-overlay-icon',
		...
		if ( ! empty( $overlay_icon_size_hover ) ) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => $hover_element . ':hover .edm-overlay .edm-overlay-icon',
		...
		// Overlay background.
		$this->get_custom_bg_style( $render_slug, 'overlay', '%%order_class%% .edm-overlay', '' );
	}
	...
	protected function get_carousel_option_fields( $supports = null, $default = null, $show_if = null ) {
		...
		$fields = array(
			...
			'animation_speed'         => array(
				'label'           => esc_html__( 'Animation Speed', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can define sliding Speed.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '700ms',
				'fixed_unit'      => 'ms',
			...
			'is_autoplay'             => array(
				'label'       => esc_html__( 'Autoplay', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Here you can choose whether autoplay should be used.', 'edm-exclusive-divi-modules' ),
				'type'        => 'yes_no_button',
				'default'     => 'on',
				'toggle_slug' => 'carousel_settings',
				'sub_toggle'  => 'general',
			...
			'autoplay_speed'          => array(
				'label'          => esc_html__( 'Autoplay Speed', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Here you can define sliding autoplay speed for the carousel.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '2000ms',
				'fixed_unit'     => 'ms',
				'toggle_slug'    => 'carousel_settings',
			...
			'use_nav'                 => array(
				'label'           => esc_html__( 'Use Navigation', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can choose whether navigation should be used.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'on',
				'toggle_slug'     => 'carousel_settings',
			...
			'use_pagi'                => array(
				'label'           => esc_html__( 'Use Pagination', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can choose whether pagination should be used.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'off',
				'toggle_slug'     => 'carousel_settings',
			...
			'is_variable_width'       => array(
				'label'           => esc_html__( 'Use Fixed Width Slide', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can choose whether fixed width slider item should be used.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'off',
				'toggle_slug'     => 'carousel_settings',
			...
			'slide_width'             => array(
				'label'          => esc_html__( 'Slide Width', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Define fixed width for the slides.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '360px',
				'fixed_unit'     => 'px',
				'mobile_options' => true,
			...
			'slide_count'             => array(
				'label'          => esc_html__( 'Slides To Show', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Define how many items you want to display in the carousel.', 'edm-exclusive-divi-modules' ),
				'type'           => 'select',
				'default'        => $slide_count,
				'toggle_slug'    => 'carousel_settings',
				'sub_toggle'     => 'general',
				'mobile_options' => true,
				'options'        => array(
					'1' => esc_html__( '1', 'edm-exclusive-divi-modules' ),
					'2' => esc_html__( '2', 'edm-exclusive-divi-modules' ),
					'3' => esc_html__( '3', 'edm-exclusive-divi-modules' ),
					'4' => esc_html__( '4', 'edm-exclusive-divi-modules' ),
					'5' => esc_html__( '5', 'edm-exclusive-divi-modules' ),
					'6' => esc_html__( '6', 'edm-exclusive-divi-modules' ),
					'7' => esc_html__( '7', 'edm-exclusive-divi-modules' ),
					'8' => esc_html__( '8', 'edm-exclusive-divi-modules' ),
				),
				'show_if'        => array_merge( $show_if, array( 'is_variable_width' => 'off' ) ),
			),

			'slide_spacing'           => array(
				'label'          => esc_html__( 'Slide Spacing', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Here you can define spaces between carousel items.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '10px',
				'fixed_unit'     => 'px',
				'toggle_slug'    => 'carousel_settings',
			...
			'use_both_side_spacing'   => array(
				'label'           => esc_html__( 'Apply Spacing on First & Last Item', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'If enable slide spacing will be applied to the first and last item.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'on',
				'toggle_slug'     => 'carousel_settings',
			...
			'is_infinite'             => array(
				'label'           => esc_html__( 'Infinite looping', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Choose whether the endless of times sliding should be played or not.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'on',
				'toggle_slug'     => 'carousel_settings',
			...
			'css_transition'          => array(
				'label'       => esc_html__( 'Sliding CSS Transition', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Define sliding CSS transition during the carousel animation.', 'edm-exclusive-divi-modules' ),
				'type'        => 'select',
				'default'     => 'ease-in-out',
				'toggle_slug' => 'carousel_settings',
				'sub_toggle'  => 'advanced',
				'options'     => array(
					'linear'      => esc_html__( 'linear', 'edm-exclusive-divi-modules' ),
					'ease-in'     => esc_html__( 'ease-in', 'edm-exclusive-divi-modules' ),
					'ease-in-out' => esc_html__( 'ease-in-out', 'edm-exclusive-divi-modules' ),
				),
				'show_if'     => $show_if,
			),

			'is_swipe'                => array(
				'label'           => esc_html__( 'Swipe', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can choose whether carousel swipe should be used.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'on',
				'mobile_options'  => true,
			...
			'slide_to_scroll'         => array(
				'label'           => esc_html__( 'Items to Scroll', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define how many slides to move at once.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'default'         => '1',
				'option_category' => 'basic_option',
				'unitless'        => true,
			...
			'is_vertical'             => array(
				'label'           => esc_html__( 'Vertical Mode', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can choose whether carousel vertical mode should be used.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'off',
				'toggle_slug'     => 'carousel_settings',
			...
			'is_center'               => array(
				...
				'description'     => esc_html__( 'Here you can choose whether center mode should be used.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'off',
				'toggle_slug'     => 'carousel_settings',
			...
			'center_mode_type'        => array(
				'label'       => esc_html__( 'Center Mode Type', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Define center mode type from the list.', 'edm-exclusive-divi-modules' ),
				'type'        => 'select',
				'default'     => 'classic',
				'toggle_slug' => 'carousel_settings',
				'sub_toggle'  => 'advanced',
				'options'     => array(
					'classic'     => esc_html__( 'Classic', 'edm-exclusive-divi-modules' ),
					'highlighted' => esc_html__( 'Highlighted', 'edm-exclusive-divi-modules' ),
				),
			...
			'center_padding'          => array(
				'label'          => esc_html__( 'Center Padding', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Define side padding when in center mode.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '70px',
				'fixed_unit'     => 'px',
				'range_settings' => array(
			...
			'wait_for_animate'        => array(
				'label'           => esc_html__( 'Wait For Animate', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__(
					'Ignores requests to advance the slide while animating
				.',
					'edm-exclusive-divi-modules'
				),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'on',
			...
			'custom_cursor'           => array(
				'label'           => esc_html__( 'Use Custom Cursor', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can choose whether custom cursor should be used.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'off',
				'toggle_slug'     => 'carousel_settings',
			...
			'cursor_name'             => array(
				'label'       => esc_html__( 'Cursor Name', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Define cursor name from the list.', 'edm-exclusive-divi-modules' ),
				'type'        => 'select',
				'default'     => 'css_default',
				'toggle_slug' => 'carousel_settings',
				'sub_toggle'  => 'advanced',
				'options'     => array(
					'css_default'   => esc_html__( 'Default', 'edm-exclusive-divi-modules' ),
					'css_none'      => esc_html__( 'None', 'edm-exclusive-divi-modules' ),
					'css_grab'      => esc_html__( 'Grab', 'edm-exclusive-divi-modules' ),
					'css_pointer'   => esc_html__( 'Pointer', 'edm-exclusive-divi-modules' ),
					'css_move'      => esc_html__( 'Move', 'edm-exclusive-divi-modules' ),
					'custom_pizza'  => esc_html__( 'Pizza', 'edm-exclusive-divi-modules' ),
					'custom_burger' => esc_html__( 'Burger', 'edm-exclusive-divi-modules' ),
				),
			...
			'carousel_spacing_top'    => array(
				'label'          => esc_html__( 'Wrapper Spacing Top', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Define spacing at the top of the carousel.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '50px',
				'fixed_unit'     => 'px',
				'toggle_slug'    => 'carousel_settings',
			...
			'carousel_spacing_bottom' => array(
				'label'          => esc_html__( 'Wrapper Spacing Bottom', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Define spacing at the bottom of the carousel.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '50px',
				'fixed_unit'     => 'px',
				'toggle_slug'    => 'carousel_settings',
			...
			// Navigation.
			'nav_type'                => array(
				'label'       => esc_html__( 'Type', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Define navigation type.', 'edm-exclusive-divi-modules' ),
				'type'        => 'select',
				'default'     => 'default',
				'toggle_slug' => 'nav',
				'tab_slug'    => 'advanced',
				...
				'options'     => array(
					'default'   => esc_html__( 'Type A', 'edm-exclusive-divi-modules' ),
					'alongside' => esc_html__( 'Type B', 'edm-exclusive-divi-modules' ),
				),
				'show_if'     => $show_if,
			),

			'nav_pos'                 => array(
				'label'       => esc_html__( 'Vertical Placement', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Define navigation vertical placement.', 'edm-exclusive-divi-modules' ),
				'type'        => 'select',
				'default'     => 'top',
				'toggle_slug' => 'nav',
				'tab_slug'    => 'advanced',
			...
			'nav_pos_hz'              => array(
				'label'       => esc_html__( 'Horizontal Placement', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Define navigation horizontal placement.', 'edm-exclusive-divi-modules' ),
				'type'        => 'select',
				'default'     => 'left',
				'toggle_slug' => 'nav',
				'tab_slug'    => 'advanced',
			...
			'nav_height'              => array(
				'label'           => esc_html__( 'Height', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can define custom height for the navigation buttons.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '40px',
				'fixed_unit'      => 'px',
			...
			'nav_width'               => array(
				'label'           => esc_html__( 'Width', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can define custom width for the navigation buttons.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '40px',
				'fixed_unit'      => 'px',
			...
			'nav_icon_size'           => array(
				...
				'description'     => esc_html__( 'Define icon size for the navigation.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '30px',
				'toggle_slug'     => 'nav',
			...
			'nav_color'               => array(
				...
				'description' => esc_html__( 'Pick a color for the navigation icon.', 'edm-exclusive-divi-modules' ),
				'type'        => 'color-alpha',
				'tab_slug'    => 'advanced',
				'toggle_slug' => 'nav',
				'default'     => '#333333',
			...
			'nav_bg'                  => array(
				'label'       => esc_html__( 'Background', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Pick a color to use for navigation background.', 'edm-exclusive-divi-modules' ),
				'type'        => 'color-alpha',
				'tab_slug'    => 'advanced',
				'toggle_slug' => 'nav',
				'default'     => '#ddd',
			...
			'nav_skew'                => array(
				'label'           => esc_html__( 'Skew', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define a value to skew navigation buttons in a two-dimensional space.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '0deg',
				'fixed_unit'      => 'deg',
			...
			'nav_gap'                 => array(
				'label'           => esc_html__( 'Spacing Between', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define spacing between navigation buttons.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '10px',
				'default_unit'    => 'px',
			...
			'nav_pos_y'               => array(
				'label'           => esc_html__( 'Vertical Position', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define a value for the navigation vertical placement.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '50%',
				'mobile_options'  => true,
			...
			'nav_x_center'            => array(
				'label'       => esc_html__( 'Use Horizontal Position Center', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Here you can choose whether navigation should be horizontal center.', 'edm-exclusive-divi-modules' ),
				'type'        => 'yes_no_button',
				'default'     => 'off',
				'toggle_slug' => 'nav',
				'tab_slug'    => 'advanced',
			...
			'nav_pos_x'               => array(
				'label'           => esc_html__( 'Horizontal Position', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define a value for the navigation horizontal placement.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'mobile_options'  => true,
				'default'         => '-15px',
			...
			'nav_border_width'        => array(
				'label'           => esc_html__( 'Border Width', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define border width for the navigation.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '0px',
				'default_unit'    => 'px',
			...
			'nav_border_color'        => array(
				'label'       => esc_html__( 'Border Color', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Pick a color to use for navigation border.', 'edm-exclusive-divi-modules' ),
				'type'        => 'color-alpha',
				'default'     => '#333',
				'toggle_slug' => 'nav',
				'tab_slug'    => 'advanced',
			...
			'nav_border_style'        => array(
				'label'       => esc_html__( 'Border Type', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Borders support various different styles, each of which will change the shape of the border element.', 'edm-exclusive-divi-modules' ),
				'type'        => 'select',
				'default'     => 'solid',
				'toggle_slug' => 'nav',
				'tab_slug'    => 'advanced',
				...
				'options'     => array(
					...
					'none'   => esc_html__( 'None', 'edm-exclusive-divi-modules' ),
				),
				'show_if'     => $show_if,
			),
			...
			// Left Arrow.
			'icon_left'               => array(
				'label'           => esc_html__( 'Prev Icon', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define custom icon for the prev navigation button.', 'edm-exclusive-divi-modules' ),
				'type'            => 'select_icon',
				'option_category' => 'basic_option',
				'toggle_slug'     => 'nav',
				'tab_slug'        => 'advanced',
			...
			'left_border_radius'      => array(
				'label'       => esc_html__( 'Border Radius', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Here you can control the corner radius of the prev nav. Enable the link icon to control all four corners at once, or disable to define custom values for each.', 'edm-exclusive-divi-modules' ),
				'type'        => 'border-radius',
			...
			// Right Arrow
			'icon_right'              => array(
				'label'           => esc_html__( 'Next Icon', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define custom icon for the next navigation button.', 'edm-exclusive-divi-modules' ),
				'type'            => 'select_icon',
				'option_category' => 'basic_option',
				'toggle_slug'     => 'nav',
				'tab_slug'        => 'advanced',
			...
			'right_border_radius'     => array(
				'label'       => esc_html__( 'Border Radius', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Here you can control the corner radius of the next nav. Enable the link icon to control all four corners at once, or disable to define custom values for each.', 'edm-exclusive-divi-modules' ),
				'type'        => 'border-radius',
				'default'     => 'on|40px|40px|40px|40px',
				'toggle_slug' => 'nav',
				'tab_slug'    => 'advanced',
			...
			'pagi_type'               => array(
				'label'       => esc_html__( 'Type', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Define pagination type from the list.', 'edm-exclusive-divi-modules' ),
				'type'        => 'select',
				'default'     => 'dot',
				'toggle_slug' => 'pagi',
				...
				'tab_slug'    => 'advanced',
				'options'     => array(
					'dot'    => esc_html__( 'Dot', 'edm-exclusive-divi-modules' ),
					'number' => esc_html__( 'Number', 'edm-exclusive-divi-modules' ),
				),
				'show_if'     => $show_if,
			),

			'pagi_alignment'          => array(
				'label'            => esc_html__( 'Alignment', 'edm-exclusive-divi-modules' ),
				'description'      => esc_html__( 'Align pagination to the left, right or center.', 'edm-exclusive-divi-modules' ),
				'type'             => 'text_align',
				'option_category'  => 'layout',
			...
			'pagi_color'              => array(
				...
				'description' => esc_html__( 'Pick a color to use for the pagination text.', 'edm-exclusive-divi-modules' ),
				'type'        => 'color-alpha',
				'tab_slug'    => 'advanced',
				'toggle_slug' => 'pagi',
				'sub_toggle'  => 'pagi_common',
			...
			'pagi_text'               => array(
				'label'           => esc_html__( 'Text Size', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define a size to use for the pagination text.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '18px',
				'toggle_slug'     => 'pagi',
			...
			'pagi_bg'                 => array(
				'label'       => esc_html__( 'Background', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Pick a color to use for the pagination background.', 'edm-exclusive-divi-modules' ),
				'type'        => 'color-alpha',
				'tab_slug'    => 'advanced',
				'toggle_slug' => 'pagi',
				'sub_toggle'  => 'pagi_common',
			...
			'pagi_height'             => array(
				'label'           => esc_html__( 'Height', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define a height for the pagination dots.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '10px',
				'toggle_slug'     => 'pagi',
			...
			'pagi_width'              => array(
				'label'           => esc_html__( 'Width', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Define a width for the pagination dots.', 'edm-exclusive-divi-modules' ),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '10px',
				'toggle_slug'     => 'pagi',
			...
			'pagi_radius'             => array(
				'label'       => esc_html__( 'Border Radius', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Here you can control the corner radius of the dots. Enable the link icon to control all four corners at once, or disable to define custom values for each.', 'edm-exclusive-divi-modules' ),
				'type'        => 'border-radius',
			...
			'pagi_pos_y'              => array(
				'label'          => esc_html__( 'Vertical Position', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Define a value for the pagination vertical placement.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '10px',
				'toggle_slug'    => 'pagi',
				'sub_toggle'     => 'pagi_common',
			...
			'pagi_spacing'            => array(
				'label'          => esc_html__( 'Spacing', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Define spacing between pagination dots.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'default'        => '10px',
				'fixed_unit'     => 'px',
				'toggle_slug'    => 'pagi',
			...
			'pagi_bg_active'          => array(
				'label'       => esc_html__( 'Background', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Pick a color to use for the active pagination dot.', 'edm-exclusive-divi-modules' ),
				'type'        => 'color-alpha',
				'tab_slug'    => 'advanced',
				'toggle_slug' => 'pagi',
			...
			'pagi_text_active'        => array(
				'label'       => esc_html__( 'Text Color', 'edm-exclusive-divi-modules' ),
				'description' => esc_html__( 'Pick a color to use for the active pagination text.', 'edm-exclusive-divi-modules' ),
				'type'        => 'color-alpha',
				'tab_slug'    => 'advanced',
				'toggle_slug' => 'pagi',
				'sub_toggle'  => 'pagi_active',
			...
			'pagi_width_active'       => array(
				'label'          => esc_html__( 'Width', 'edm-exclusive-divi-modules' ),
				'description'    => esc_html__( 'Define a width for the active pagination dot.', 'edm-exclusive-divi-modules' ),
				'type'           => 'range',
				'fixed_unit'     => 'px',
				'toggle_slug'    => 'pagi',
				'sub_toggle'     => 'pagi_active',
		...
		if ( in_array( 'lightbox', $supports, true ) ) {
			...
			$aditional['use_lightbox'] = array(
				'label'           => esc_html__( 'Open Image in Lightbox', 'edm-exclusive-divi-modules' ),
				'description'     => esc_html__( 'Here you can choose whether image should be opened with lightbox.', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'off',
				'toggle_slug'     => 'carousel_settings',
		...
		if ( in_array( 'equal_height', $supports, true ) ) {
			...
			$aditional['is_equal_height'] = array(
				'label'           => esc_html__( 'Equalize Item Height', 'edm-exclusive-divi-modules' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'description'     => esc_html__( 'Enable this to Equalize all Carousel items with same height.', 'edm-exclusive-divi-modules' ),
				'options'         => array(
					'on'  => esc_html__( 'Yes', 'edm-exclusive-divi-modules' ),
					'off' => esc_html__( 'No', 'edm-exclusive-divi-modules' ),
				),
	...
	protected function render_pagination_css( $render_slug ) {
		...
		if ( $pagi_type === 'dot' ) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .edm-carousel .slick-dots li button',
			...
			if ( ! empty( $pagi_color_hover ) ) {
				ET_Builder_Element::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%% .edm-carousel .slick-dots li:hover button',
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .edm-carousel .slick-dots',
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .edm-carousel .slick-dots li',
		...
		if ( ! empty( $pagi_bg_active ) ) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .edm-carousel .slick-dots li.slick-active button',
	...
	protected function render_carousel_css( $render_slug ) {
		...
		$this->generate_styles(
			array(
				...
				'important'      => true,
				'selector'       => '%%order_class%% .edm-carousel .slick-prev:before',
				'processor'      => array(
		...
		$this->generate_styles(
			array(
				...
				'important'      => true,
				'selector'       => '%%order_class%% .edm-carousel .slick-next:before',
				'processor'      => array(
					'ET_Builder_Module_Helper_Style_Processor',
					'process_extended_icon',
				),
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .edm-centered--highlighted .slick-slide',
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .edm-carousel .slick-track',
		...
		if ( 'on' === $is_variable_width ) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .edm-carousel .slick-slide',
		...
		if ( 'off' === $is_vertical ) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .edm-carousel .slick-slide, .et-db #et-boc %%order_class%% .edm-carousel .slick-slide',
			...
			if ( 'off' === $use_both_side_spacing ) {
				ET_Builder_Element::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%% .edm-carousel .slick-list, .et-db #et-boc %%order_class%% .edm-carousel .slick-list',
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .edm-carousel .slick-arrow',
				'declaration' => sprintf(
		...
		if ( $nav_color_hover ) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .edm-carousel .slick-arrow:hover',
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .edm-carousel .slick-arrow:before',
				'declaration' => sprintf(
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .edm-carousel .slick-next',
				'declaration' => sprintf(
					'border-radius: %1$s %2$s %3$s %4$s;',
		...
		ET_Builder_Element::set_style(
			$render_slug,
			array(
				'selector'    => '%%order_class%% .edm-carousel .slick-prev',
				'declaration' => sprintf(
					'border-radius: %1$s %2$s %3$s %4$s;',
	...
	protected function get_image_hover_animations() {
		return array(
			'none'        => esc_html__( 'None', 'edm-exclusive-divi-modules' ),
			'zoom-in'     => esc_html__( 'Zoom In', 'edm-exclusive-divi-modules' ),
			'zoom-out'    => esc_html__( 'Zoom Out', 'edm-exclusive-divi-modules' ),
			...
			'rubberBand'  => esc_html__( 'Rubber Band', 'edm-exclusive-divi-modules' ),
			...
			'jello'       => esc_html__( 'Jello', 'edm-exclusive-divi-modules' ),
			'heartBeat'   => esc_html__( 'Heart Beat', 'edm-exclusive-divi-modules' ),
			'bounceIn'    => esc_html__( 'Bounce In', 'edm-exclusive-divi-modules' ),
			'fadeIn'      => esc_html__( 'Fade In', 'edm-exclusive-divi-modules' ),
			'flip'        => esc_html__( 'Flip', 'edm-exclusive-divi-modules' ),
			'rotateIn'    => esc_html__( 'Rotate In', 'edm-exclusive-divi-modules' ),
			'slideInUp'   => esc_html__( 'Slide In Up', 'edm-exclusive-divi-modules' ),
			'slideInDown' => esc_html__( 'Slide In Down', 'edm-exclusive-divi-modules' ),
		);
	}
